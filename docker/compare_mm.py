...
def test_flash_attention():
    ...
    def get_clock(handle):
        ...
        active_clock = pynvml.nvmlDeviceGetClockInfo(handle, 0)
    ...
    def matmul_tma_ws_persistent_txl(a, b, profiling=True):
        # Check constraints.
