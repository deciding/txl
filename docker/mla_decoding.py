...
@app.function(
    gpu="H100", image=txl_image, timeout=60 * 3, volumes={"/workspace/dump": volume}
)
def test_mla_decoding(dump_dir: str = "default"):
    import subprocess
    import torch
    ...
    main(torch.float16, dump_dir=dump_path)
...
def main():
    ...
    test_mla_decoding.remote(dump_dir)
