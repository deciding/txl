...
test_file = tutorial_path / "test_flash_mla_decoding.py"

flash_mla_dir = tutorial_path / "flash_mla"

app = App(name="txl-mla-decoding")  # Note: this is optional since Modal 0.57
volume = Volume.from_name("txl-mla-decodoing-dump", create_if_missing=True) # create a cloud volume to store compiled dump files
