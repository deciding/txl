...
def mla_test(q, kv, qpe, kpe, sm_scale, algo=0):
    ...
    algo_map = {
        0: mla_decode_latent_sharedZ_wsNsplit_txl,
        1: mla_decode_latent_sharedZ_wsNsplit_txl_debug
    }
...
if __name__ == "__main__":
    ...
    print("TEST...")
    test_op(16, 32, 1024, 1, 1024, 128, 64, algo=0, no_tune=no_tune)
    test_op(16, 32, 1024, 1, 1024, 128, 64, algo=1, no_tune=no_tune)