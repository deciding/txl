...
test_file = local_dir / "tilelang" / "benchmark_flashinfer.py"
kernel_file = local_dir / "tilelang" / "example_mla_decode_paged.py"
...
txl_image = (
    ...
    .add_local_file(kernel_file, remote_path="/workspace/example_mla_decode_paged.py", copy=False)
...
def run_demo():
    ...
    if get_gpu_type():
        print("Running on H100 GPU with HBM3 memory.")
        import_cuBLAS_lib()
        test_demo()