...
#define GEN_PASS_DEF_TXLGPUOPTIMIZEDOTOPERANDS
#include "nvidia/include/Dialect/TXLGPU/Transforms/Passes.h.inc"

class TXLGPUOptimizeDotOperandsPass
    : public impl::TXLGPUOptimizeDotOperandsBase<
          TXLGPUOptimizeDotOperandsPass> {
public:
  using impl::TXLGPUOptimizeDotOperandsBase<
      TXLGPUOptimizeDotOperandsPass>::TXLGPUOptimizeDotOperandsBase;
