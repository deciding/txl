...
#define GEN_PASS_DEF_TXLGPUACCELERATEMATMUL
#include "nvidia/include/Dialect/TXLGPU/Transforms/Passes.h.inc"

class TXLGPUAccelerateMatmulPass
    : public impl::TXLGPUAccelerateMatmulBase<
          TXLGPUAccelerateMatmulPass> {
public:
  using impl::TXLGPUAccelerateMatmulBase<
      TXLGPUAccelerateMatmulPass>::TXLGPUAccelerateMatmulBase;
