...
def get_base_dir():
    return os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, os.pardir, "thirdparty", "triton"))

def get_zlang_base_dir():
...
def get_cmake_dir():
    ...
    cmake_dir = Path(get_zlang_base_dir()) / "build" / dir_name
...
class BackendInstaller:
    ...
    def prepare(backend_name: str, backend_src_dir: str = None, is_external: bool = False):
        ...
        install_dir = os.path.join(get_base_dir(), "python", "triton", "backends", backend_name)
...
def update_symlink(link_path, source_path):
    print(f"ln -s {source_path} {link_path}")
...
class CMakeBuild(build_ext):
    ...
    def initialize_options(self):
        ...
        self.base_dir = get_zlang_base_dir()
...
cur_ext = CMakeExtension("zlang", "_C")
