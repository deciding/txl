...
def _attn_fwd_inner(acc, l_i, m_i, q,  #
    ...
    for start_n in range(lo, hi, BLOCK_N):
        ...
        acc = txtxl.dot(p, v, acc) # (BM, BN) * (BN, D)
        # update m_i and l_i
        m_i = m_ij
...
# CUDA_VISIBLE_DEVICES=3 TRITON_ALWAYS_COMPILE=1  python xyzlang/zlang/tests/tmp.py
# TRITON_KERNEL_DUMP=1 TRITON_DUMP_DIR=dump/tmp CUDA_VISIBLE_DEVICES=3 TRITON_ALWAYS_COMPILE=1 python xyzlang/zlang/tests/tmp.py
# TRITON_LLVM_DEBUG_ONLY="tritongpu-warp-spec-data-partition"
@txl.jit
