...
tma_ws_best_config_split = {'BLOCK_M':256, 'BLOCK_N':64, 'NUM_CONSUMERS': 2, 'NUM_STAGES': 2} # stages: 3, num warps: 4, num_warpgroups: 3
...
@txl.jit
#@txl.jit(diff_mode="llir")
def _attn_fwd_ws_tma_txl5(sm_scale, M,  #
              Z, H, desc_q, desc_k, desc_v, desc_o, N_CTX,  #
              HEAD_DIM: tl.constexpr,  #
              BLOCK_M: tl.constexpr,  #
              BLOCK_N: tl.constexpr,  #
...
@txl.jit
def _attn_fwd_ws_tma_txl6(sm_scale, M,  #
              Z, H, desc_q, desc_k, desc_v, desc_o, N_CTX,  #
              HEAD_DIM: tl.constexpr,  #
              BLOCK_M: tl.constexpr,  #
              BLOCK_N: tl.constexpr,  #
...
@txl.jit
#@txl.jit(diff_mode='ttgir', diff_select=6, log_dir='dump')
def _attn_fwd_ws_tma_txl7(sm_scale, M,  #
              Z, H, desc_q, desc_k, desc_v, desc_o, N_CTX,  #
              HEAD_DIM: tl.constexpr,  #
              BLOCK_M: tl.constexpr,  #
              BLOCK_N: tl.constexpr,  #
...
@txl.jit
#@txl.jit(diff_mode='ttgir')
def _attn_fwd_ws_tma_txl_own1(sm_scale, M,  #
              Z, H, desc_q, desc_k, desc_v, desc_o, N_CTX,  #
              HEAD_DIM: tl.constexpr,  #
              BLOCK_M: tl.constexpr,  #
              BLOCK_N: tl.constexpr,  #
